...
To see your own vault as a galaxy, [Agentage Galaxy](obsidian://show-plugin?id=agentage-galaxy) is one click in Obsidian: free, open source, and fully local. This piece was originally published on [Medium](https://medium.com/@vreshch).
